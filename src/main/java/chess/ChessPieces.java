...
public class ChessPieces {
    ...
    public int[][] movePiece(ChessPieces piece, int board[][], int newRow, int newCol){
    	...
    	{	
	    	...
	    	if(piece.pieceValue.equals("Pawn")){
	    	...
	    	if(piece.pieceValue.equals("Rook")){
	    	...
	    	//move the bishop
	    	if(piece.pieceValue.equals("Bishop")){
			...
			if(piece.pieceValue.equals("Knight")){
			...
			if(piece.pieceValue.equals("Queen")){
			...
			if(piece.pieceValue.equals("King")){
